                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-3 xl:gap-[1.250vw] pb-5">
                        ...
                        <div className="relative z-10 col-span-12 lg:col-span-9" data-aos="fade-down" data-aos-duration="800">
                            <div className="bg-[#fff] box-shadow-2 radius8 border border-[#E4E7EC]" >
                                ...
                                <Sidebar className="relative reports-popup" visible={visible} position={position} style={{ width: '50vw' }} onHide={() => setVisible(false)} draggable={false} resizable={false}>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-12">
                                        <div className="col-span-1 lg:col-span-8 bg-[#F5F6F7] h-auto">
                                            <div className="p-5">
                                                ...
                                                <div className="text-[#113699] text-sm lg:text-[0.833vw] font-bold">Glendale Unified School District</div>
                                                <div className="text-[#344054] text-xs lg:text-[0.625vw] font-medium">Weekly Absence Report - Classified form</div>

                                                <div className="pt-3">
                                                    <div className="flex justify-between text-[#344054] text-[12px] py-[14px] px-[8px] border-b border-[#E4E7EC]">
                                                    ...
                                                    <div className="flex justify-between text-[#344054] text-[12px] py-[16px] px-[8px]">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2">
                                                        ...
                                                        <div className="text-[#344054] text-[12px]">
                                                            <div className="grid grid-cols-5 pb-0.5">
                                                                ...
                                                                <div className="col-span-4">Last Day Worked</div>
                                                            </div>
                                                            <div className="grid grid-cols-5 pb-0.5">
                                                                <div className="col-span-1 font-semibold">NA -</div>
                                                                <div className="col-span-4">Personal (Not Approved)</div>
                                                            </div>
                                                            <div className="grid grid-cols-5 pb-0.5">
                                                                <div className="col-span-1 font-semibold">OU -</div>
                                                                <div className="col-span-4">Other Unpaid</div>
                                                            </div>
                                                            <div className="grid grid-cols-5 pb-0.5">
                                                                <div className="col-span-1 font-semibold">PA -</div>
                                                                <div className="col-span-4">Personal (Approved)</div>
                                                            </div>
                                                            <div className="grid grid-cols-5 pb-0.5">
                                                                <div className="col-span-1 font-semibold">WC -</div>
                                                                <div className="col-span-4">Personal (Approved)</div>
                                                            </div>
                                                            <div className="grid grid-cols-5 pb-0.5">
                                                                <div className="col-span-1 font-semibold">D -</div>
                                                                <div className="col-span-4">District Approved</div>
                                                            </div>
                                                            <div className="grid grid-cols-5 pb-0.5">
                                                                <div className="col-span-1 font-semibold">I -</div>
                                                                <div className="col-span-4">Illness</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
